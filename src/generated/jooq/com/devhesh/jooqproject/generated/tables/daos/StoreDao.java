...
public class StoreDao extends DAOImpl<StoreRecord, com.devhesh.jooqproject.generated.tables.pojos.Store, UInteger> {
    ...
    @Override
    public UInteger getId(com.devhesh.jooqproject.generated.tables.pojos.Store object) {
     ...
     * upperInclusive</code>
     */
    public List<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchRangeOfStoreId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchByStoreId(UInteger... values) {
     ...
     */
    public com.devhesh.jooqproject.generated.tables.pojos.Store fetchOneByStoreId(UInteger value) {
     ...
     * Fetch a unique record that has <code>store_id = value</code>
     */
    public Optional<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchOptionalByStoreId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchRangeOfManagerStaffId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchByManagerStaffId(UInteger... values) {
     ...
     */
    public com.devhesh.jooqproject.generated.tables.pojos.Store fetchOneByManagerStaffId(UInteger value) {
     ...
     * Fetch a unique record that has <code>manager_staff_id = value</code>
     */
    public Optional<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchOptionalByManagerStaffId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchRangeOfAddressId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.devhesh.jooqproject.generated.tables.pojos.Store> fetchByAddressId(UInteger... values) {
